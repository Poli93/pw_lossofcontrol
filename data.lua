...
private.LOSS_OF_CONTROL_INTERRUPTS_DATA = {
	...
	[57994] = {duration = 2, name = "Wind Shear", icon = "Interface\\Icons\\spell_nature_cyclone"},
	[19647] = {duration = 6, name = "Spell Lock", icon = "Interface\\Icons\\spell_shadow_mindrot"},
	[2139] = {duration = 8, name = "Counterspell", icon = "Interface\\Icons\\spell_frost_iceshock"},
	[16979] = {duration = 4, name = "Kick", icon = "Interface\\Icons\\ability_hunter_pet_bear"},
	[26090] = {duration = 2, name = "Pummel", icon = "Interface\\Icons\\ability_hunter_pet_gorilla"},
};

private.LOSS_OF_CONTROL_SPELL_SCHOOLS_DATA = {
